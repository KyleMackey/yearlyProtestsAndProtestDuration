...
##
url <- "https://raw.githubusercontent.com/KyleMackey/yearlyProtestsAndProtestDuration/master/data/protestnum.csv"
...
actionButton(inputId = 'ab1', 
             ...
             icon = icon("th"), 
             onclick = "window.open('https://github.com/KyleMackey/yearlyProtestsAndProtestDuration', '_blank')"),
br()
